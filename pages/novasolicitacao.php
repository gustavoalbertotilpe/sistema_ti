<?php
    ...
    if(isset($_POST["solicitacao"]) && empty($_POST["solicitacao"])==false)
    {
        ...
        solicitacao($nome,$emaildestino,$nomedestino,$solicitacao);
        ...
        <div class="formulario">
            <form action='' method='POST'>
                ...
                <div class="form-group">
                    <input type='text' class="form-control" name="nomedestino" placeholder="Nome do detinatario da Solicitação" disabled value="<?php echo $consulta->getNomeComprador();?>">
                </div>
                <div class="form-group">
                    <input type='text' class="form-control" name="emaildestino" placeholder="E-mail do detinatario da Solicitação" disabled value="<?php echo $consulta->getEmailComprador();?>">
                </div>
                <br>
                <div class="form-group">
                    <textarea  id='idSolicitacao'class="form-control" name='solicitacao' required  ></textarea>
                    <br>
